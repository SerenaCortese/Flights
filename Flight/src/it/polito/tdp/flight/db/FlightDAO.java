...
public class FlightDAO {
	...
	public List<Route> getAllRoutes(RouteIdMap routeIdMap, AirportIdMap airportIdmap, AirlineIdMap airlineIdMap) {
		...
		try {
			...
			while (res.next()) {
				...
				Route route = new Route(counter,airline,sourceAirport,destinationAirport, res.getString("Codeshare"), res.getInt("Stops"),
